...
- `quartus/` - Quartus project and pin-assignment files for hardware rebuild.
...
This repository is source-focused: RTL, project files, simulation assets, documentation, and test evidence are included; Quartus databases, reports, bitstreams, and simulator caches are excluded.
